...
class EpicTest {
    ...
    void getString() {
        ...
        String expected = epicOne.getUid() + ",EPIC,Name of epic one,NEW,Description of epic one," + epicOne.getStartTime().format(FORMATTER) + ",0,,\n";
    ...
    void getEndTime() {
        Epic epicOne = new Epic("Name of epic one", "Description of epic one");
        int uidEpicOne = taskManager.createTask(epicOne);
        LocalDateTime subtaskOneStartTime = LocalDateTime.now().plusMinutes(1l);
        ...
        subtaskOne.setStatus(IN_PROGRESS);
        LocalDateTime subtaskTwoStartTime = subtaskOneStartTime.plusHours(2l);
        Long subtaskTwoDuration = 2l;
        int uidSubtaskOne = taskManager.createTask(subtaskOne);
        ...
        subtaskTwo.setStatus(IN_PROGRESS);
        int uidSubtaskTwo = taskManager.createTask(subtaskTwo);
        LocalDateTime subtaskThreeStartTime = subtaskTwoStartTime.plusDays(2l);
        Long subtaskThreeDuration = 4l;
        ...
        epicOne.setSubtaskUidSet(new HashSet<>(Arrays.asList(uidSubtaskOne, uidSubtaskTwo, uidSubtaskThree)));
        taskManager.update(uidEpicOne, epicOne);
        Long expectedDuration = subtaskOneDuration + subtaskTwoDuration + subtaskThreeDuration;
